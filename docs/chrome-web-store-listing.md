...
Everything needed to fill out the Developer Dashboard for **Google Country Override**
(item ID `bhdgkkgclnmbbgaejncimldlfebalada`). Images are generated by `make store-assets` into
`store/`.
